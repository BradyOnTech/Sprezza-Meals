...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_meal_categories_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__meal_categories_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_dietary_tags_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__dietary_tags_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_meal_bases_weight_unit" AS ENUM('g', 'oz', 'lb');
  CREATE TYPE "public"."enum_meal_bases_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__meal_bases_v_version_weight_unit" AS ENUM('g', 'oz', 'lb');
  CREATE TYPE "public"."enum__meal_bases_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_customization_categories_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__customization_categories_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_customization_options_weight_unit" AS ENUM('g', 'oz', 'lb');
  CREATE TYPE "public"."enum_customization_options_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__customization_options_v_version_weight_unit" AS ENUM('g', 'oz', 'lb');
  CREATE TYPE "public"."enum__customization_options_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_meals_nutrition_weight_unit" AS ENUM('g', 'oz', 'lb');
  CREATE TYPE "public"."enum_meals_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__meals_v_version_nutrition_weight_unit" AS ENUM('g', 'oz', 'lb');
  CREATE TYPE "public"."enum__meals_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_meal_plans_items_day_of_week" AS ENUM('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday');
  CREATE TYPE "public"."enum_meal_plans_items_meal_time" AS ENUM('breakfast', 'lunch', 'dinner', 'snack');
  CREATE TYPE "public"."enum_meal_plans_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__meal_plans_v_version_items_day_of_week" AS ENUM('monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday', 'sunday');
  CREATE TYPE "public"."enum__meal_plans_v_version_items_meal_time" AS ENUM('breakfast', 'lunch', 'dinner', 'snack');
  CREATE TYPE "public"."enum__meal_plans_v_version_status" AS ENUM('draft', 'published');
  ...
  CREATE TABLE "meal_categories" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_meal_categories_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_meal_categories_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_title" varchar,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__meal_categories_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  ...
  CREATE TABLE "dietary_tags" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_dietary_tags_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_dietary_tags_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__dietary_tags_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  
  CREATE TABLE "meal_bases" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  	"generate_slug" boolean DEFAULT true,
  	"slug" varchar,
  	...
  	"base_price" numeric,
  	"weight" numeric,
  	"weight_unit" "enum_meal_bases_weight_unit" DEFAULT 'g',
  	"food_type" varchar,
  	"use_auto_nutrition" boolean DEFAULT false,
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_meal_bases_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_meal_bases_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_name" varchar,
  	"version_generate_slug" boolean DEFAULT true,
  	...
  	"version_weight_unit" "enum__meal_bases_v_version_weight_unit" DEFAULT 'g',
  	"version_food_type" varchar,
  	"version_use_auto_nutrition" boolean DEFAULT false,
  	"version_nutrition_calories" numeric,
  	"version_nutrition_protein" numeric,
  	"version_nutrition_carbs" numeric,
  	"version_nutrition_fat" numeric,
  	"version_nutrition_fiber" numeric,
  	"version_nutrition_sugar" numeric,
  	"version_is_active" boolean DEFAULT true,
  	"version_image_id" integer,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__meal_bases_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  ...
  CREATE TABLE "customization_categories" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_customization_categories_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_customization_categories_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_name" varchar,
  	"version_description" varchar,
  	"version_display_order" numeric DEFAULT 0,
  	"version_min_selections" numeric,
  	"version_max_selections" numeric,
  	"version_is_required" boolean DEFAULT false,
  	"version_is_active" boolean DEFAULT true,
  	"version_generate_slug" boolean DEFAULT true,
  	"version_slug" varchar,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__customization_categories_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  ...
  CREATE TABLE "customization_options" (
  	...
  	"weight" numeric,
  	"weight_unit" "enum_customization_options_weight_unit" DEFAULT 'g',
  	"food_type" varchar,
  	"use_auto_nutrition" boolean DEFAULT false,
  	"nutrition_calories" numeric,
  	"nutrition_protein" numeric,
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_customization_options_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_customization_options_v" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"parent_id" integer,
  	"version_name" varchar,
  	"version_generate_slug" boolean DEFAULT true,
  	...
  	"version_description" varchar,
  	"version_price_adjustment" numeric DEFAULT 0,
  	"version_weight" numeric,
  	"version_weight_unit" "enum__customization_options_v_version_weight_unit" DEFAULT 'g',
  	"version_food_type" varchar,
  	"version_use_auto_nutrition" boolean DEFAULT false,
  	"version_nutrition_calories" numeric,
  	"version_nutrition_protein" numeric,
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__customization_options_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean
  );
  ...
  CREATE TABLE "meals_media_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"image_id" integer
  ...
  CREATE TABLE "meals" (
  	...
  	"flags_is_featured" boolean DEFAULT false,
  	"flags_is_active" boolean DEFAULT true,
  	"nutrition_use_auto_nutrition" boolean DEFAULT false,
  	"nutrition_weight" numeric,
  	"nutrition_weight_unit" "enum_meals_nutrition_weight_unit" DEFAULT 'g',
  	"nutrition_calories" numeric,
  	"nutrition_protein" numeric,
  	"nutrition_carbs" numeric,
  	"nutrition_fat" numeric,
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_meals_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "meals_rels" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"order" integer,
  	"parent_id" integer NOT NULL,
  	"path" varchar NOT NULL,
  	"meal_categories_id" integer,
  	"dietary_tags_id" integer,
  	"customization_categories_id" integer,
  	"meals_id" integer
  );
  
  CREATE TABLE "_meals_v_version_ingredients" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"name" varchar,
  ...
  CREATE TABLE "_meals_v_version_media_gallery" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"image_id" integer,
  ...
  CREATE TABLE "_meals_v" (
  	...
  	"version_meal_base_id" integer,
  	"version_price" numeric,
  	"version_prep_time_minutes" numeric,
  	"version_servings" numeric,
  	"version_availability_start_date" timestamp(3) with time zone,
  	"version_availability_end_date" timestamp(3) with time zone,
  	"version_flags_is_featured" boolean DEFAULT false,
  	"version_flags_is_active" boolean DEFAULT true,
  	"version_nutrition_use_auto_nutrition" boolean DEFAULT false,
  	"version_nutrition_weight" numeric,
  	"version_nutrition_weight_unit" "enum__meals_v_version_nutrition_weight_unit" DEFAULT 'g',
  	"version_nutrition_calories" numeric,
  	"version_nutrition_protein" numeric,
  	"version_nutrition_carbs" numeric,
  	"version_nutrition_fat" numeric,
  	"version_nutrition_fiber" numeric,
  	"version_nutrition_sugar" numeric,
  	"version_media_image_id" integer,
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__meals_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean,
  	"autosave" boolean
  ...
  CREATE TABLE "meal_plans_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"day_of_week" "enum_meal_plans_items_day_of_week",
  	"meal_time" "enum_meal_plans_items_meal_time",
  	"meal_id" integer,
  	"notes" varchar,
  ...
  CREATE TABLE "meal_plans" (
  	...
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"_status" "enum_meal_plans_status" DEFAULT 'draft'
  );
  
  CREATE TABLE "_meal_plans_v_version_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"day_of_week" "enum__meal_plans_v_version_items_day_of_week",
  	"meal_time" "enum__meal_plans_v_version_items_meal_time",
  	"meal_id" integer,
  	"notes" varchar,
  	"display_order" numeric,
  	"_uuid" varchar
  ...
  CREATE TABLE "_meal_plans_v" (
  	...
  	"version_updated_at" timestamp(3) with time zone,
  	"version_created_at" timestamp(3) with time zone,
  	"version__status" "enum__meal_plans_v_version_status" DEFAULT 'draft',
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"latest" boolean,
  	"autosave" boolean
  ...
  CREATE TABLE "payload_locked_documents_rels" (
  	...
  	"meal_categories_id" integer,
  	"dietary_tags_id" integer,
  	"meal_bases_id" integer,
  	"customization_categories_id" integer,
  	"customization_options_id" integer,
  	"meals_id" integer,
  ...
  CREATE TABLE "site_settings_how_it_works" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  CREATE TABLE "_site_settings_v_version_how_it_works" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"title" varchar,
  ...
  ALTER TABLE "_meal_categories_v" ADD CONSTRAINT "_meal_categories_v_parent_id_meal_categories_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."meal_categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_dietary_tags_v" ADD CONSTRAINT "_dietary_tags_v_parent_id_dietary_tags_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."dietary_tags"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "meal_bases" ADD CONSTRAINT "meal_bases_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meal_bases_v" ADD CONSTRAINT "_meal_bases_v_parent_id_meal_bases_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."meal_bases"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meal_bases_v" ADD CONSTRAINT "_meal_bases_v_version_image_id_media_id_fk" FOREIGN KEY ("version_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_customization_categories_v" ADD CONSTRAINT "_customization_categories_v_parent_id_customization_categories_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."customization_categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "customization_options" ADD CONSTRAINT "customization_options_category_id_customization_categories_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."customization_categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "customization_options" ADD CONSTRAINT "customization_options_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_customization_options_v" ADD CONSTRAINT "_customization_options_v_parent_id_customization_options_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."customization_options"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_customization_options_v" ADD CONSTRAINT "_customization_options_v_version_category_id_customization_categories_id_fk" FOREIGN KEY ("version_category_id") REFERENCES "public"."customization_categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_customization_options_v" ADD CONSTRAINT "_customization_options_v_version_image_id_media_id_fk" FOREIGN KEY ("version_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "meals_ingredients" ADD CONSTRAINT "meals_ingredients_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."meals"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meals_media_gallery" ADD CONSTRAINT "meals_media_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "meals_media_gallery" ADD CONSTRAINT "meals_media_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."meals"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meals" ADD CONSTRAINT "meals_meal_base_id_meal_bases_id_fk" FOREIGN KEY ("meal_base_id") REFERENCES "public"."meal_bases"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "meals" ADD CONSTRAINT "meals_media_image_id_media_id_fk" FOREIGN KEY ("media_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "meals_rels" ADD CONSTRAINT "meals_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."meals"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meals_rels" ADD CONSTRAINT "meals_rels_meal_categories_fk" FOREIGN KEY ("meal_categories_id") REFERENCES "public"."meal_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meals_rels" ADD CONSTRAINT "meals_rels_dietary_tags_fk" FOREIGN KEY ("dietary_tags_id") REFERENCES "public"."dietary_tags"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meals_rels" ADD CONSTRAINT "meals_rels_customization_categories_fk" FOREIGN KEY ("customization_categories_id") REFERENCES "public"."customization_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meals_rels" ADD CONSTRAINT "meals_rels_meals_fk" FOREIGN KEY ("meals_id") REFERENCES "public"."meals"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meals_v_version_ingredients" ADD CONSTRAINT "_meals_v_version_ingredients_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_meals_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meals_v_version_media_gallery" ADD CONSTRAINT "_meals_v_version_media_gallery_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meals_v_version_media_gallery" ADD CONSTRAINT "_meals_v_version_media_gallery_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_meals_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meals_v" ADD CONSTRAINT "_meals_v_parent_id_meals_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."meals"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meals_v" ADD CONSTRAINT "_meals_v_version_meal_base_id_meal_bases_id_fk" FOREIGN KEY ("version_meal_base_id") REFERENCES "public"."meal_bases"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meals_v" ADD CONSTRAINT "_meals_v_version_media_image_id_media_id_fk" FOREIGN KEY ("version_media_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meals_v_rels" ADD CONSTRAINT "_meals_v_rels_parent_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."_meals_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meals_v_rels" ADD CONSTRAINT "_meals_v_rels_meal_categories_fk" FOREIGN KEY ("meal_categories_id") REFERENCES "public"."meal_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meals_v_rels" ADD CONSTRAINT "_meals_v_rels_dietary_tags_fk" FOREIGN KEY ("dietary_tags_id") REFERENCES "public"."dietary_tags"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meals_v_rels" ADD CONSTRAINT "_meals_v_rels_customization_categories_fk" FOREIGN KEY ("customization_categories_id") REFERENCES "public"."customization_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meals_v_rels" ADD CONSTRAINT "_meals_v_rels_meals_fk" FOREIGN KEY ("meals_id") REFERENCES "public"."meals"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meal_plans_items" ADD CONSTRAINT "meal_plans_items_meal_id_meals_id_fk" FOREIGN KEY ("meal_id") REFERENCES "public"."meals"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "meal_plans_items" ADD CONSTRAINT "meal_plans_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."meal_plans"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "meal_plans" ADD CONSTRAINT "meal_plans_image_id_media_id_fk" FOREIGN KEY ("image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meal_plans_v_version_items" ADD CONSTRAINT "_meal_plans_v_version_items_meal_id_meals_id_fk" FOREIGN KEY ("meal_id") REFERENCES "public"."meals"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meal_plans_v_version_items" ADD CONSTRAINT "_meal_plans_v_version_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_meal_plans_v"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "_meal_plans_v" ADD CONSTRAINT "_meal_plans_v_parent_id_meal_plans_id_fk" FOREIGN KEY ("parent_id") REFERENCES "public"."meal_plans"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "_meal_plans_v" ADD CONSTRAINT "_meal_plans_v_version_image_id_media_id_fk" FOREIGN KEY ("version_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_meal_categories_fk" FOREIGN KEY ("meal_categories_id") REFERENCES "public"."meal_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_dietary_tags_fk" FOREIGN KEY ("dietary_tags_id") REFERENCES "public"."dietary_tags"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_meal_bases_fk" FOREIGN KEY ("meal_bases_id") REFERENCES "public"."meal_bases"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_customization_categories_fk" FOREIGN KEY ("customization_categories_id") REFERENCES "public"."customization_categories"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "payload_locked_documents_rels" ADD CONSTRAINT "payload_locked_documents_rels_customization_options_fk" FOREIGN KEY ("customization_options_id") REFERENCES "public"."customization_options"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "site_settings_how_it_works" ADD CONSTRAINT "site_settings_how_it_works_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."site_settings"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_site_settings_v_version_how_it_works" ADD CONSTRAINT "_site_settings_v_version_how_it_works_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_site_settings_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE UNIQUE INDEX "meal_categories_slug_idx" ON "meal_categories" USING btree ("slug");
  CREATE INDEX "meal_categories_updated_at_idx" ON "meal_categories" USING btree ("updated_at");
  CREATE INDEX "meal_categories_created_at_idx" ON "meal_categories" USING btree ("created_at");
  CREATE INDEX "meal_categories__status_idx" ON "meal_categories" USING btree ("_status");
  CREATE INDEX "_meal_categories_v_parent_idx" ON "_meal_categories_v" USING btree ("parent_id");
  CREATE INDEX "_meal_categories_v_version_version_slug_idx" ON "_meal_categories_v" USING btree ("version_slug");
  CREATE INDEX "_meal_categories_v_version_version_updated_at_idx" ON "_meal_categories_v" USING btree ("version_updated_at");
  CREATE INDEX "_meal_categories_v_version_version_created_at_idx" ON "_meal_categories_v" USING btree ("version_created_at");
  CREATE INDEX "_meal_categories_v_version_version__status_idx" ON "_meal_categories_v" USING btree ("version__status");
  CREATE INDEX "_meal_categories_v_created_at_idx" ON "_meal_categories_v" USING btree ("created_at");
  CREATE INDEX "_meal_categories_v_updated_at_idx" ON "_meal_categories_v" USING btree ("updated_at");
  CREATE INDEX "_meal_categories_v_latest_idx" ON "_meal_categories_v" USING btree ("latest");
  CREATE UNIQUE INDEX "dietary_tags_slug_idx" ON "dietary_tags" USING btree ("slug");
  CREATE INDEX "dietary_tags_updated_at_idx" ON "dietary_tags" USING btree ("updated_at");
  CREATE INDEX "dietary_tags_created_at_idx" ON "dietary_tags" USING btree ("created_at");
  CREATE INDEX "dietary_tags__status_idx" ON "dietary_tags" USING btree ("_status");
  CREATE INDEX "_dietary_tags_v_parent_idx" ON "_dietary_tags_v" USING btree ("parent_id");
  CREATE INDEX "_dietary_tags_v_version_version_slug_idx" ON "_dietary_tags_v" USING btree ("version_slug");
  CREATE INDEX "_dietary_tags_v_version_version_updated_at_idx" ON "_dietary_tags_v" USING btree ("version_updated_at");
  CREATE INDEX "_dietary_tags_v_version_version_created_at_idx" ON "_dietary_tags_v" USING btree ("version_created_at");
  CREATE INDEX "_dietary_tags_v_version_version__status_idx" ON "_dietary_tags_v" USING btree ("version__status");
  CREATE INDEX "_dietary_tags_v_created_at_idx" ON "_dietary_tags_v" USING btree ("created_at");
  CREATE INDEX "_dietary_tags_v_updated_at_idx" ON "_dietary_tags_v" USING btree ("updated_at");
  CREATE INDEX "_dietary_tags_v_latest_idx" ON "_dietary_tags_v" USING btree ("latest");
  CREATE UNIQUE INDEX "meal_bases_slug_idx" ON "meal_bases" USING btree ("slug");
  CREATE INDEX "meal_bases_image_idx" ON "meal_bases" USING btree ("image_id");
  CREATE INDEX "meal_bases_updated_at_idx" ON "meal_bases" USING btree ("updated_at");
  CREATE INDEX "meal_bases_created_at_idx" ON "meal_bases" USING btree ("created_at");
  CREATE INDEX "meal_bases__status_idx" ON "meal_bases" USING btree ("_status");
  CREATE INDEX "_meal_bases_v_parent_idx" ON "_meal_bases_v" USING btree ("parent_id");
  CREATE INDEX "_meal_bases_v_version_version_slug_idx" ON "_meal_bases_v" USING btree ("version_slug");
  CREATE INDEX "_meal_bases_v_version_version_image_idx" ON "_meal_bases_v" USING btree ("version_image_id");
  CREATE INDEX "_meal_bases_v_version_version_updated_at_idx" ON "_meal_bases_v" USING btree ("version_updated_at");
  CREATE INDEX "_meal_bases_v_version_version_created_at_idx" ON "_meal_bases_v" USING btree ("version_created_at");
  CREATE INDEX "_meal_bases_v_version_version__status_idx" ON "_meal_bases_v" USING btree ("version__status");
  CREATE INDEX "_meal_bases_v_created_at_idx" ON "_meal_bases_v" USING btree ("created_at");
  CREATE INDEX "_meal_bases_v_updated_at_idx" ON "_meal_bases_v" USING btree ("updated_at");
  CREATE INDEX "_meal_bases_v_latest_idx" ON "_meal_bases_v" USING btree ("latest");
  CREATE UNIQUE INDEX "customization_categories_slug_idx" ON "customization_categories" USING btree ("slug");
  CREATE INDEX "customization_categories_updated_at_idx" ON "customization_categories" USING btree ("updated_at");
  CREATE INDEX "customization_categories_created_at_idx" ON "customization_categories" USING btree ("created_at");
  CREATE INDEX "customization_categories__status_idx" ON "customization_categories" USING btree ("_status");
  CREATE INDEX "_customization_categories_v_parent_idx" ON "_customization_categories_v" USING btree ("parent_id");
  CREATE INDEX "_customization_categories_v_version_version_slug_idx" ON "_customization_categories_v" USING btree ("version_slug");
  CREATE INDEX "_customization_categories_v_version_version_updated_at_idx" ON "_customization_categories_v" USING btree ("version_updated_at");
  CREATE INDEX "_customization_categories_v_version_version_created_at_idx" ON "_customization_categories_v" USING btree ("version_created_at");
  CREATE INDEX "_customization_categories_v_version_version__status_idx" ON "_customization_categories_v" USING btree ("version__status");
  CREATE INDEX "_customization_categories_v_created_at_idx" ON "_customization_categories_v" USING btree ("created_at");
  CREATE INDEX "_customization_categories_v_updated_at_idx" ON "_customization_categories_v" USING btree ("updated_at");
  CREATE INDEX "_customization_categories_v_latest_idx" ON "_customization_categories_v" USING btree ("latest");
  CREATE UNIQUE INDEX "customization_options_slug_idx" ON "customization_options" USING btree ("slug");
  CREATE INDEX "customization_options_category_idx" ON "customization_options" USING btree ("category_id");
  CREATE INDEX "customization_options_image_idx" ON "customization_options" USING btree ("image_id");
  CREATE INDEX "customization_options_updated_at_idx" ON "customization_options" USING btree ("updated_at");
  CREATE INDEX "customization_options_created_at_idx" ON "customization_options" USING btree ("created_at");
  CREATE INDEX "customization_options__status_idx" ON "customization_options" USING btree ("_status");
  CREATE INDEX "_customization_options_v_parent_idx" ON "_customization_options_v" USING btree ("parent_id");
  CREATE INDEX "_customization_options_v_version_version_slug_idx" ON "_customization_options_v" USING btree ("version_slug");
  CREATE INDEX "_customization_options_v_version_version_category_idx" ON "_customization_options_v" USING btree ("version_category_id");
  CREATE INDEX "_customization_options_v_version_version_image_idx" ON "_customization_options_v" USING btree ("version_image_id");
  CREATE INDEX "_customization_options_v_version_version_updated_at_idx" ON "_customization_options_v" USING btree ("version_updated_at");
  CREATE INDEX "_customization_options_v_version_version_created_at_idx" ON "_customization_options_v" USING btree ("version_created_at");
  CREATE INDEX "_customization_options_v_version_version__status_idx" ON "_customization_options_v" USING btree ("version__status");
  CREATE INDEX "_customization_options_v_created_at_idx" ON "_customization_options_v" USING btree ("created_at");
  CREATE INDEX "_customization_options_v_updated_at_idx" ON "_customization_options_v" USING btree ("updated_at");
  CREATE INDEX "_customization_options_v_latest_idx" ON "_customization_options_v" USING btree ("latest");
  CREATE INDEX "meals_ingredients_order_idx" ON "meals_ingredients" USING btree ("_order");
  CREATE INDEX "meals_ingredients_parent_id_idx" ON "meals_ingredients" USING btree ("_parent_id");
  CREATE INDEX "meals_media_gallery_order_idx" ON "meals_media_gallery" USING btree ("_order");
  CREATE INDEX "meals_media_gallery_parent_id_idx" ON "meals_media_gallery" USING btree ("_parent_id");
  CREATE INDEX "meals_media_gallery_image_idx" ON "meals_media_gallery" USING btree ("image_id");
  CREATE UNIQUE INDEX "meals_slug_idx" ON "meals" USING btree ("slug");
  CREATE INDEX "meals_meal_base_idx" ON "meals" USING btree ("meal_base_id");
  CREATE INDEX "meals_media_media_image_idx" ON "meals" USING btree ("media_image_id");
  ...
  CREATE INDEX "meals__status_idx" ON "meals" USING btree ("_status");
  CREATE INDEX "meals_rels_order_idx" ON "meals_rels" USING btree ("order");
  CREATE INDEX "meals_rels_parent_idx" ON "meals_rels" USING btree ("parent_id");
  CREATE INDEX "meals_rels_path_idx" ON "meals_rels" USING btree ("path");
  CREATE INDEX "meals_rels_meal_categories_id_idx" ON "meals_rels" USING btree ("meal_categories_id");
  CREATE INDEX "meals_rels_dietary_tags_id_idx" ON "meals_rels" USING btree ("dietary_tags_id");
  CREATE INDEX "meals_rels_customization_categories_id_idx" ON "meals_rels" USING btree ("customization_categories_id");
  CREATE INDEX "meals_rels_meals_id_idx" ON "meals_rels" USING btree ("meals_id");
  CREATE INDEX "_meals_v_version_ingredients_order_idx" ON "_meals_v_version_ingredients" USING btree ("_order");
  CREATE INDEX "_meals_v_version_ingredients_parent_id_idx" ON "_meals_v_version_ingredients" USING btree ("_parent_id");
  CREATE INDEX "_meals_v_version_media_gallery_order_idx" ON "_meals_v_version_media_gallery" USING btree ("_order");
  CREATE INDEX "_meals_v_version_media_gallery_parent_id_idx" ON "_meals_v_version_media_gallery" USING btree ("_parent_id");
  CREATE INDEX "_meals_v_version_media_gallery_image_idx" ON "_meals_v_version_media_gallery" USING btree ("image_id");
  CREATE INDEX "_meals_v_parent_idx" ON "_meals_v" USING btree ("parent_id");
  CREATE INDEX "_meals_v_version_version_slug_idx" ON "_meals_v" USING btree ("version_slug");
  CREATE INDEX "_meals_v_version_version_meal_base_idx" ON "_meals_v" USING btree ("version_meal_base_id");
  CREATE INDEX "_meals_v_version_media_version_media_image_idx" ON "_meals_v" USING btree ("version_media_image_id");
  CREATE INDEX "_meals_v_version_version_updated_at_idx" ON "_meals_v" USING btree ("version_updated_at");
  CREATE INDEX "_meals_v_version_version_created_at_idx" ON "_meals_v" USING btree ("version_created_at");
  CREATE INDEX "_meals_v_version_version__status_idx" ON "_meals_v" USING btree ("version__status");
  CREATE INDEX "_meals_v_created_at_idx" ON "_meals_v" USING btree ("created_at");
  CREATE INDEX "_meals_v_updated_at_idx" ON "_meals_v" USING btree ("updated_at");
  CREATE INDEX "_meals_v_latest_idx" ON "_meals_v" USING btree ("latest");
  CREATE INDEX "_meals_v_autosave_idx" ON "_meals_v" USING btree ("autosave");
  CREATE INDEX "_meals_v_rels_order_idx" ON "_meals_v_rels" USING btree ("order");
  CREATE INDEX "_meals_v_rels_parent_idx" ON "_meals_v_rels" USING btree ("parent_id");
  CREATE INDEX "_meals_v_rels_path_idx" ON "_meals_v_rels" USING btree ("path");
  CREATE INDEX "_meals_v_rels_meal_categories_id_idx" ON "_meals_v_rels" USING btree ("meal_categories_id");
  CREATE INDEX "_meals_v_rels_dietary_tags_id_idx" ON "_meals_v_rels" USING btree ("dietary_tags_id");
  CREATE INDEX "_meals_v_rels_customization_categories_id_idx" ON "_meals_v_rels" USING btree ("customization_categories_id");
  CREATE INDEX "_meals_v_rels_meals_id_idx" ON "_meals_v_rels" USING btree ("meals_id");
  CREATE INDEX "meal_plans_items_order_idx" ON "meal_plans_items" USING btree ("_order");
  CREATE INDEX "meal_plans_items_parent_id_idx" ON "meal_plans_items" USING btree ("_parent_id");
  CREATE INDEX "meal_plans_items_meal_idx" ON "meal_plans_items" USING btree ("meal_id");
  CREATE UNIQUE INDEX "meal_plans_slug_idx" ON "meal_plans" USING btree ("slug");
  CREATE INDEX "meal_plans_image_idx" ON "meal_plans" USING btree ("image_id");
  ...
  CREATE INDEX "meal_plans__status_idx" ON "meal_plans" USING btree ("_status");
  CREATE INDEX "_meal_plans_v_version_items_order_idx" ON "_meal_plans_v_version_items" USING btree ("_order");
  CREATE INDEX "_meal_plans_v_version_items_parent_id_idx" ON "_meal_plans_v_version_items" USING btree ("_parent_id");
  CREATE INDEX "_meal_plans_v_version_items_meal_idx" ON "_meal_plans_v_version_items" USING btree ("meal_id");
  CREATE INDEX "_meal_plans_v_parent_idx" ON "_meal_plans_v" USING btree ("parent_id");
  CREATE INDEX "_meal_plans_v_version_version_slug_idx" ON "_meal_plans_v" USING btree ("version_slug");
  CREATE INDEX "_meal_plans_v_version_version_image_idx" ON "_meal_plans_v" USING btree ("version_image_id");
  CREATE INDEX "_meal_plans_v_version_version_updated_at_idx" ON "_meal_plans_v" USING btree ("version_updated_at");
  CREATE INDEX "_meal_plans_v_version_version_created_at_idx" ON "_meal_plans_v" USING btree ("version_created_at");
  CREATE INDEX "_meal_plans_v_version_version__status_idx" ON "_meal_plans_v" USING btree ("version__status");
  CREATE INDEX "_meal_plans_v_created_at_idx" ON "_meal_plans_v" USING btree ("created_at");
  CREATE INDEX "_meal_plans_v_updated_at_idx" ON "_meal_plans_v" USING btree ("updated_at");
  CREATE INDEX "_meal_plans_v_latest_idx" ON "_meal_plans_v" USING btree ("latest");
  CREATE INDEX "_meal_plans_v_autosave_idx" ON "_meal_plans_v" USING btree ("autosave");
  ...
  CREATE INDEX "payload_locked_documents_rels_meal_categories_id_idx" ON "payload_locked_documents_rels" USING btree ("meal_categories_id");
  CREATE INDEX "payload_locked_documents_rels_dietary_tags_id_idx" ON "payload_locked_documents_rels" USING btree ("dietary_tags_id");
  CREATE INDEX "payload_locked_documents_rels_meal_bases_id_idx" ON "payload_locked_documents_rels" USING btree ("meal_bases_id");
  CREATE INDEX "payload_locked_documents_rels_customization_categories_i_idx" ON "payload_locked_documents_rels" USING btree ("customization_categories_id");
  CREATE INDEX "payload_locked_documents_rels_customization_options_id_idx" ON "payload_locked_documents_rels" USING btree ("customization_options_id");
  ...
  CREATE INDEX "site_settings_how_it_works_order_idx" ON "site_settings_how_it_works" USING btree ("_order");
  CREATE INDEX "site_settings_how_it_works_parent_id_idx" ON "site_settings_how_it_works" USING btree ("_parent_id");
  ...
  CREATE INDEX "_site_settings_v_version_how_it_works_order_idx" ON "_site_settings_v_version_how_it_works" USING btree ("_order");
  CREATE INDEX "_site_settings_v_version_how_it_works_parent_id_idx" ON "_site_settings_v_version_how_it_works" USING btree ("_parent_id");
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "meal_categories" CASCADE;
  DROP TABLE "_meal_categories_v" CASCADE;
  DROP TABLE "dietary_tags" CASCADE;
  DROP TABLE "_dietary_tags_v" CASCADE;
  DROP TABLE "meal_bases" CASCADE;
  DROP TABLE "_meal_bases_v" CASCADE;
  DROP TABLE "customization_categories" CASCADE;
  DROP TABLE "_customization_categories_v" CASCADE;
  DROP TABLE "customization_options" CASCADE;
  DROP TABLE "_customization_options_v" CASCADE;
  DROP TABLE "meals_ingredients" CASCADE;
  DROP TABLE "meals_media_gallery" CASCADE;
  DROP TABLE "meals" CASCADE;
  DROP TABLE "meals_rels" CASCADE;
  DROP TABLE "_meals_v_version_ingredients" CASCADE;
  DROP TABLE "_meals_v_version_media_gallery" CASCADE;
  DROP TABLE "_meals_v" CASCADE;
  DROP TABLE "_meals_v_rels" CASCADE;
  DROP TABLE "meal_plans_items" CASCADE;
  DROP TABLE "meal_plans" CASCADE;
  DROP TABLE "_meal_plans_v_version_items" CASCADE;
  DROP TABLE "_meal_plans_v" CASCADE;
  ...
  DROP TABLE "site_settings_how_it_works" CASCADE;
  DROP TABLE "site_settings_faq" CASCADE;
  DROP TABLE "site_settings" CASCADE;
  DROP TABLE "_site_settings_v_version_how_it_works" CASCADE;
  ...
  DROP TYPE "public"."enum_meal_categories_status";
  DROP TYPE "public"."enum__meal_categories_v_version_status";
  DROP TYPE "public"."enum_dietary_tags_status";
  DROP TYPE "public"."enum__dietary_tags_v_version_status";
  DROP TYPE "public"."enum_meal_bases_weight_unit";
  DROP TYPE "public"."enum_meal_bases_status";
  DROP TYPE "public"."enum__meal_bases_v_version_weight_unit";
  DROP TYPE "public"."enum__meal_bases_v_version_status";
  DROP TYPE "public"."enum_customization_categories_status";
  DROP TYPE "public"."enum__customization_categories_v_version_status";
  DROP TYPE "public"."enum_customization_options_weight_unit";
  DROP TYPE "public"."enum_customization_options_status";
  DROP TYPE "public"."enum__customization_options_v_version_weight_unit";
  DROP TYPE "public"."enum__customization_options_v_version_status";
  DROP TYPE "public"."enum_meals_nutrition_weight_unit";
  DROP TYPE "public"."enum_meals_status";
  DROP TYPE "public"."enum__meals_v_version_nutrition_weight_unit";
  DROP TYPE "public"."enum__meals_v_version_status";
  DROP TYPE "public"."enum_meal_plans_items_day_of_week";
  DROP TYPE "public"."enum_meal_plans_items_meal_time";
  DROP TYPE "public"."enum_meal_plans_status";
  DROP TYPE "public"."enum__meal_plans_v_version_items_day_of_week";
  DROP TYPE "public"."enum__meal_plans_v_version_items_meal_time";
  DROP TYPE "public"."enum__meal_plans_v_version_status";
